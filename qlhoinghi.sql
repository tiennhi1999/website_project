...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 06, 2021 lúc 09:39 AM
...
INSERT INTO `user_` (`MA_USER`, `TENUSER`, `USERNAME`, `USER_PWD`, `USER_EMAIL`, `level`, `CHAN`) VALUES
(1, 'Ksor Âu', 'autinn123', '852000', 'autinn123@gmail.com', b'1', b'0'),
(3, 'Nguyễn Hoàng Minh Trí', 'TriNguyen', '1234', 'minhtri3013@gmail.com', b'0', b'0');
...
--
ALTER TABLE `diadiemtc`
  MODIFY `MADD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `ds_dangki`
--
ALTER TABLE `ds_dangki`
  MODIFY `MA_DSDK` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `ds_thamgia`
--
ALTER TABLE `ds_thamgia`
  MODIFY `MA_DSTG` int(11) NOT NULL AUTO_INCREMENT;
